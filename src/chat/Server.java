...
public class Server implements ActionListener{
    ...
    Server()
    {
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/rab.png"));
        ...
        morevert.setBounds(412, 22, 10, 25);
        p1.add(morevert);

        JLabel name=new JLabel("Khargosh");
